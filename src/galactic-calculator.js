export class GalacticCalculator {
  ...
  lifeExpectancy(planet) {
    ...
    if (this.sex === "M") {
      ...
      return ((76.3) - (0.932 * ageRaise[1]) - (0.002 * ageRaise[2]) + (0.0000385 * ageRaise[3]) + ageRaise[1]) / this.planets[planet];
    } else {
      return ((80.9) - (0.903 * ageRaise[1]) - (0.00342 * ageRaise[2]) + (0.0000455 * ageRaise[3]) + ageRaise[1]) / this.planets[planet];
    }
  }
}